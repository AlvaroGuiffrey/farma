<?php
/**
 * Archivo de la clase indice del módulo reponer.
 *
 * Archivo de la clase de inicio del módulo reponer.
 *
...
/**
 * Clase index del módulo reponer.
 *
 * Clase de inicio del módulo reponer.
 *
...
{
    /**
     * Nos permite acceder al control del módulo reponer.
    ...
    public static function execute()
    {
        ...
        Clase::define('ReponerControl');
        // Instancia las clases
        $oLoginVO = new LoginVO();
        $oLoginControl = new LoginControl();
        $oReponerControl = new ReponerControl();
        ...
        $oReponerControl->inicio($oLoginVO, $accion);
    }
}
