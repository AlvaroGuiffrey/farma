<?php
/**
 * Archivo de la clase indice del módulo rotulo.
 *
 * Archivo de la clase de inicio del módulo rotulo.
 *
...
/**
 * Clase index del módulo rotulo.
 *
 * Clase de inicio del módulo rotulo.
 *
...
{
	/**
	 * Nos permite acceder al control del módulo rotulo.
	...
	public static function execute()
	{
		...
		Clase::define('RotuloControl');
		// Instancia las clases
		$oLoginVO = new LoginVO();
		$oLoginControl = new LoginControl();
		$oRotuloControl = new RotuloControl();
		...
		$oRotuloControl->inicio($oLoginVO, $accion);
	}
}
