 ...
 *
 * Clase de inicio del módulo artículo que permite buscar los artículos
 * con condiciones de ventas para su consulta.
 *
...
{
    /**
     * Nos permite acceder al control del módulo artículo, de los artículos
     * con condiciones de ventas para consultar.
    ...
    public static function execute()
    {
        ...
        Clase::define('ArticuloCondiControlBuscar');
        // Instancia las clases
        $oLoginVO = new LoginVO();
        $oLoginControl = new LoginControl();
        $oArticuloCondiControlBuscar = new ArticuloCondiControlBuscar();
        ...
        $oArticuloCondiControlBuscar->inicio($oLoginVO, $accion);
    }
}
