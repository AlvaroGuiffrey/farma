 ...
 *
 * Clase de inicio del módulo artículo.
 *
...
{
	/**
	 * Nos permite acceder al control del módulo artículo.
	...
	public static function execute()
	{
		...
		Clase::define('ArticuloControl');
		// Instancia las clases
		$oLoginVO = new LoginVO();
		$oLoginControl = new LoginControl();
		$oArticuloControl = new ArticuloControl();
		...
		$oArticuloControl->inicio($oLoginVO, $accion);
	}
}
