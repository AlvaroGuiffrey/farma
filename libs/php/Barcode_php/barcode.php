...
function barcode( $filepath="", $text="0", $size="20", $orientation="horizontal", $code_type="code128", $print=false, $SizeFactor=1 ) {
    ...
    $code_length = 30; // original:20 con 30 lo achica
    if ($print) {
        $text_height = 30; // original:30
    } else {
        $text_height = 0;
    }
    ...
    if ( $print ) {
        //imagestring($image, 5, 31, $img_height, $text, $black ); //original
        imagestring($image, 3, 31, $img_height, $text, $black );
    }
    $location = 10;
