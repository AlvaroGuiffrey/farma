<?php
/**
 * Archivo de la clase indice del módulo pedido.
 *
 * Archivo de la clase de inicio del módulo pedido.
 *
...
/**
 * Clase index del módulo pedido.
 *
 * Clase de inicio del módulo pedido.
 *
...
{
    /**
     * Nos permite acceder al control del módulo pedido.
    ...
    public static function execute()
    {
        ...
        Clase::define('PedidoControl');
        // Instancia las clases
        $oLoginVO = new LoginVO();
        $oLoginControl = new LoginControl();
        $oPedidoControl = new PedidoControl();
        ...
        $oPedidoControl->inicio($oLoginVO, $accion);
    }
}
