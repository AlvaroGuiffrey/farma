...
{
    /**
     * Nos permite acceder al control Casa Florian del módulo producto.
    ...
    public static function execute()
    {
        ...
        Clase::define('ProductoCFControl');
        // Instancia las clases
        $oLoginVO = new LoginVO();
        $oLoginControl = new LoginControl();
        $oProductoCFControl = new ProductoCFControl();
        ...
        $oProductoCFControl->inicio($oLoginVO, $accion);
    }
}
