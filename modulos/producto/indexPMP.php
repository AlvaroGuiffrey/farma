...
{
	/**
	 * Nos permite acceder al control de Precios Menor p/Proveedor 
	 * del módulo producto.
	...
	public static function execute()
	{
		...
		Clase::define('ProductoControlPrecioMenor');
		// Instancia las clases
		$oLoginVO = new LoginVO();
		$oLoginControl = new LoginControl();
		$oProductoControlPrecioMenor = new ProductoControlPrecioMenor();
		...
		$oProductoControlPrecioMenor->inicio($oLoginVO, $accion);
	}
}
