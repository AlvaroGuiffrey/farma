 ...
 * que nos permite cargar el control para descartar los
 * artículos con los productos de plex.
 *
 ...
 */
class IndexDescartaArticulos
{
	/**
	 * Nos permite acceder al control del módulo artículo para descartar
	 * articulos.
	...
	public static function execute()
	{
		...
		Clase::define('ArticuloControlDescarta');
		// Instancia las clases
		$oLoginVO = new LoginVO();
		$oLoginControl = new LoginControl();
		$oArticuloControlDescarta = new ArticuloControlDescarta();
		...
		$oArticuloControlDescarta->inicio($oLoginVO, $accion);
	}
}

IndexDescartaArticulos::execute();
?>