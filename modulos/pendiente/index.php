<?php
/**
 * Archivo de la clase indice del módulo pendiente.
 *
 * Archivo de la clase de inicio del módulo pendiente.
 *
...
/**
 * Clase index del módulo pendiente.
 *
 * Clase de inicio del módulo pendiente.
 *
...
{
    /**
     * Nos permite acceder al control del módulo pendiente.
    ...
    public static function execute()
    {
        ...
        Clase::define('PendienteControl');
        // Instancia las clases
        $oLoginVO = new LoginVO();
        $oLoginControl = new LoginControl();
        $oPendienteControl = new PendienteControl();
        ...
        $oPendienteControl->inicio($oLoginVO, $accion);
    }
}
