<?php
/**
 * Archivo de la clase indice del módulo recibidos.
 *
 * Archivo de la clase de inicio del módulo recibidos.
 *
...
/**
 * Clase index del módulo recibido.
 *
 * Clase de inicio del módulo recibido.
 *
...
{
	/**
	 * Nos permite acceder al control del módulo recibido.
	...
	public static function execute()
	{
		...
		Clase::define('RecibidoControl');
		// Instancia las clases
		$oLoginVO = new LoginVO();
		$oLoginControl = new LoginControl();
		$oRecibidoControl = new RecibidoControl();
		...
		$oRecibidoControl->inicio($oLoginVO, $accion);
	}
}
