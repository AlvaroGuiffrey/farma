<?php
/**
 * Archivo del include del módulo provincia.
 *
 * Archivo del include del módulo provincia que arma una select html con todos
...
/**
 * Clase del include del módulo provincia.
 *
 * Clase RubroSelect del módulo provincia que permite armar
...
class ProvinciaSelect
{
	...
	* los registros de provincias para representar en la vista.
	*
	* @param $cantidad
	* @param $items array()
	* @param $accion
