 ...
 * que permite confirmar los pedidos de artículos asignados.
 *
...
class PedidoTabla
{
     ...
     */
    static function armaTabla($items, $cantidad, $accion, $razonSocial, $canal)
    {
        ...
        // hidden para enviar información
            $renglon = $renglon.'<input type="hidden" name="razonSocial" value="'.$razonSocial.'">
        ...
        If ($cantidad==0){
            ...
            foreach ($items as $item)
            {
                ...
                $renglon  = '<tr '.$claseTR.'style="margin:0">
                        ...
                        <td>
                            <input class= "input-mini" type="number" name="cantidadProd['.$item['id'].']" value="'.$item['cantidad'].'" min="1" max="36" style="text-align:center">
                        </td>    
