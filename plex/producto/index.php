<?php
/**
 * Archivo de la clase indice de plex/producto.
 *
 * Archivo de la clase de inicio del plex/producto.
 *
...
/**
 * Clase index del plex/producto.
 *
 * Clase de inicio del plex/producto.
 *
...
{
	/**
	 * Nos permite acceder al control del plex/producto
	...
	public static function execute()
	{
		...
		Clase::define('ProductoPlexControl');
		// Instancia las clases
		$oLoginVO = new LoginVO();
		$oLoginControl = new LoginControl();
		$oProductoPlexControl = new ProductoPlexControl();
		...
		$oProductoPlexControl->inicio($oLoginVO, $accion);
	}
}
