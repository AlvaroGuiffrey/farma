 ...
 * que nos permite cargar el control para actualizar precios de los
...
class IndexActualizaArticulos
{
	...
	public static function execute()
	{
		...
		Clase::define('ArticuloControlActualiza');
		// Instancia las clases
		$oLoginVO = new LoginVO();
		$oLoginControl = new LoginControl();
		$oArticuloControlActualiza = new ArticuloControlActualiza();
		...
		$oArticuloControlActualiza->inicio($oLoginVO, $accion);
	}
}

IndexActualizaArticulos::execute();
?>