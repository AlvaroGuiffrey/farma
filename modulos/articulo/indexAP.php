 ...
 * que nos permite cargar el control para probar actualizar precios de los
 * artículos con las listas de los proveedores de referencia.
 *
...
class IndexActualizaArtPrueba
{
	...
	public static function execute()
	{
		...
		Clase::define('ArticuloControlActPrueba');
		// Instancia las clases
		$oLoginVO = new LoginVO();
		$oLoginControl = new LoginControl();
		$oArticuloControlActPrueba = new ArticuloControlActPrueba();
		...
		$oArticuloControlActPrueba->inicio($oLoginVO, $accion);
	}
}

IndexActualizaArtPrueba::execute();
?>
