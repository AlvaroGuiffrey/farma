 ...
 * para actualizar precios únicos.
 *
...
class IndexActualizaArtPU
{
    ...
    public static function execute()
    {
        ...
        Clase::define('ArticuloControlActPU');
        // Instancia las clases
        $oLoginVO = new LoginVO();
        $oLoginControl = new LoginControl();
        $oArticuloControlActPU = new ArticuloControlActPU();
        ...
        $oArticuloControlActPU->inicio($oLoginVO, $accion);
    }
}

IndexActualizaArtPU::execute();
?>