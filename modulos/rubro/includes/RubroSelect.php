 ...
 *
 * Archivo del include del módulo rubro que arma una select html con todos
 ...
 *
 * Clase RubroSelect del módulo rubro que permite armar
...
class RubroSelect 
{
	...
	* los registros de rubros para representar en la vista.
	*
	* @param $cantidad
	* @param $items array()
	* @param $accion
