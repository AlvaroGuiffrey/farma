...
{
	/**
	 * Nos permite acceder al control NIPPON SA del módulo producto.
	...
	public static function execute()
	{
		...
		Clase::define('ProductoNIControl');
		// Instancia las clases
		$oLoginVO = new LoginVO();
		$oLoginControl = new LoginControl();
		$oProductoNIControl = new ProductoNIControl();
		...
		$oProductoNIControl->inicio($oLoginVO, $accion);
	}
}
