 ...
 *
 * Clase de inicio del módulo artículo que permite acceder a los artículos 
 * con condiciones de ventas.
 *
...
class Index
{
    ...
    public static function execute()
    {
        ...
        Clase::define('ArticuloCondiControl');
        // Instancia las clases
        $oLoginVO = new LoginVO();
        $oLoginControl = new LoginControl();
        $oArticuloCondiControl = new ArticuloCondiControl();
        ...
        $oArticuloCondiControl->inicio($oLoginVO, $accion);
    }
}
