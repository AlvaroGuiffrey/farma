<?php
/**
 * Archivo de la clase indice del módulo rubro.
 *
 * Archivo de la clase de inicio del módulo rubro.
 *
...
/**
 * Clase index del inicio del inicio del módulo rubro.
 *
 * Clase de inicio del módulo rubro.
 *
...
{
	/**
	 * Nos permite acceder al control del módulo rubro.
	...
	public static function execute()
	{
		...
		Clase::define('RubroControl');
		// Instancia las clases
		$oLoginVO = new LoginVO();
		$oLoginControl = new LoginControl();
		$oRubroControl = new RubroControl();
		...
		$oRubroControl->inicio($oLoginVO, $accion);
	}
}
