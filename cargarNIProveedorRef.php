<?php
/*
 * Carga por primera vez Nippon como segundo proveedor de referencia para los precios
...
*
*  Lee el código de barra de un artículo y lo compara para el proveedor Nippon
...
echo "CARGA NIPPON COMO 2º PROV. DE REF.PARA LOS PRECIO DE </br>";
