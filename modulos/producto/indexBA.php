...
{
	/**
	 * Nos permite acceder al control Babelito del módulo producto.
	...
	public static function execute()
	{
		...
		Clase::define('ProductoBAControl');
		// Instancia las clases
		$oLoginVO = new LoginVO();
		$oLoginControl = new LoginControl();
		$oProductoBAControl = new ProductoBAControl();
		...
		$oProductoBAControl->inicio($oLoginVO, $accion);
	}
}
