<?php
/**
 * Archivo de la clase indice del módulo localidad.
 *
 * Archivo de la clase de inicio del módulo localidad.
 *
...
/**
 * Clase index del módulo localidad.
 *
 * Clase de inicio del módulo localidad.
 *
...
{
	/**
	 * Nos permite acceder al control del módulo localidad.
	...
	public static function execute()
	{
		...
		Clase::define('LocalidadControl');
		// Instancia las clases
		$oLoginVO = new LoginVO();
		$oLoginControl = new LoginControl();
		$oLocalidadControl = new LocalidadControl();
		...
		$oLocalidadControl->inicio($oLoginVO, $accion);
	}
}
