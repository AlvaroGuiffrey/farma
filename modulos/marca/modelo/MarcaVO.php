 ...
 * estructura de la tabla marcas en un objeto para poder
...
/**
 * Clase que nos permite mapear la tabla marcas a un objeto.
 *
 * Clase que nos permite mapear la tabla marcas a un objeto
 * que utlizaremos luego para realizar operaciones de tipo
 * CRUD y otras sobre la tabla marcas ubicada en la DB caro.
 *
 * @copyright  Copyright (c) 2015 Alvaro A. Guiffrey (http://www.alvaroguiffrey.com.ar)
 * @license    http://www.gnu.org/licenses/   GPL License
 * @version    1.0
...
class MarcaVO 
{
	...
	#Métodos
	/**
	* Nos permite obtener el identificador de la marca.
	*
	* @return integer
	*/
	...
	/**
	 * Nos permite obtener el nombre de la marca.
	 *
	 * @return string
	 */
	...
	/**
	 * Nos permite obtener el comentario sobre la marca.
	 *
	 * @return string
	 */
	...
	/**
	 * Nos permite establecer el identificador de la marca.
	 *
	 * @param integer $id
	 */
	...
	/**
	 * Nos permite establecer el nombre de la marca.
	 *
	 * @param string $nombre
	 */
	...
	/**
	 * Nos permite establecer comentario para la marca.
	 *
