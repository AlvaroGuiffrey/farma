	...
	private function accionControl($oLoginVO)
	{
		...
		switch ($this->_accion){
			...
			case 'Iniciar':
				...
				$oCargarVista->setCarga('datos', '/modulos/producto/vista/actualizarProductosNI.html');
				...
				$oDatoVista->setDato('{alertaAdvertencia}',  'Si la lista contiene caracteres especiales, seleccione antes de actualizar.');
			...
			case 'Actualizar':
				...
				$this->_switchCaracter = "NO";
				if (isset($_POST['sw_caracter'])) $this->_switchCaracter = $_POST['sw_caracter'];
				echo "Switch : ".$this->_switchCaracter."<br>";
			 ...
			 */
				...
				//echo "CODIGOS DE PRODUCTO REPETIDOS<br>";
				//var_dump($this->_aProductos);
				//echo "<br> Cantidad Leidos repetidos: ".$oProductoProvModelo->getCantidad()."<br>";
