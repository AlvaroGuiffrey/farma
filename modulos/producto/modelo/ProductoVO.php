 ...
 *
 * Archivo de la clase ProductosVO que nos permite mapear la
 * estructura de la tabla productos en un objeto para poder
...
/**
 * Clase que nos permite mapear la tabla productos a un objeto.
 *
 * Clase que nos permite mapear la tabla productos a un objeto
 * que utlizaremos luego para realizar operaciones de tipo
 * CRUD y otras sobre la tabla productos ubicada en la DB.
 *
 * @copyright  Copyright (c) 2015 Alvaro A. Guiffrey (http://www.alvaroguiffrey.com.ar)
 * @license    http://www.gnu.org/licenses/   GPL License
 * @version    1.0
