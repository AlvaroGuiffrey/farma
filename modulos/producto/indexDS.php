...
{
	/**
	 * Nos permite acceder al control Drogueria del Sud del módulo producto.
	...
	public static function execute()
	{
		...
		Clase::define('ProductoDSControl');

		// Instancia las clases
		$oLoginVO = new LoginVO();
		$oLoginControl = new LoginControl();
		$oProductoDSControl = new ProductoDSControl();
		...
		$oProductoDSControl->inicio($oLoginVO, $accion);
	}
}
