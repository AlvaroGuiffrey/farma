 ...
 *
 * Clase RotuloCondiTabla del módulo rótulo que permite armar
 * una tabla con todos los registros seleccionados para la vista listar
 * que permite confirmar los rótulos de articulos_condi a descargar.
 *
...
class RotuloCondiTabla
{
    ...
    static function armaTabla($items, $cantidad, $accion)
    {
        ...
        if ($accion=='Descartar'){
            ...
            fwrite($handle, '<caption>Listado de artículos c/condiciones</caption>'.PHP_EOL);
        }
        // Pie de la tabla
        $renglon = '<tfoot><tr>
			<td></td><td>Son: '.$cantidad.' rótulos</td><td></td><td></td><td></td></tr>
			</tfoot>'.PHP_EOL;
        ...
        fwrite($handle, '<thead><tr>
                            ...
                            <th title="Presentación del artículo">Presentación</th>
                            <th title="Condición de venta del artículo">Condición</th>
                            <th title="Seleccione las acciones para el rótulo del artículo">Acciones</th>
                        </tr></thead>'.PHP_EOL);
            ...
            foreach ($items as $item)
            {
                ...
                if ($accion=='Descartar'){
                    $renglon  = '<tr>
                        ...
                        <td style="text-align:left"><span class="label label-default">'.$item['nombreCondi'].'</span></td>
