<?php
/**
 * Archivo de la clase indice del módulo proveedor.
 *
 * Archivo de la clase de inicio del módulo proveedor.
 *
...
/**
 * Clase index del módulo proveedor.
 *
 * Clase de inicio del módulo proveedor.
 *
...
{
	/**
	 * Nos permite acceder al control del módulo proveedor.
	...
	public static function execute()
	{
		...
		Clase::define('ProveedorControl');
		// Instancia las clases
		$oLoginVO = new LoginVO();
		$oLoginControl = new LoginControl();
		$oProveedorControl = new ProveedorControl();
		...
		$oProveedorControl->inicio($oLoginVO, $accion);
	}
}
