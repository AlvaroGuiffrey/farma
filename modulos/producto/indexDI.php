...
{
	/**
	 * Nos permite acceder al control Dispita del módulo producto.
	...
	public static function execute()
	{
		...
		Clase::define('ProductoDIControl');
		// Instancia las clases
		$oLoginVO = new LoginVO();
		$oLoginControl = new LoginControl();
		$oProductoDIControl = new ProductoDIControl();
		...
		$oProductoDIControl->inicio($oLoginVO, $accion);
	}
}
